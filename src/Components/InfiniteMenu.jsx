...
export default function InfiniteMenu({ items = [] }) {
  ...
  return (
    <div className="relative w-full h-full bg-slate-500 rounded-3xl border-2 border-red-600">
      <canvas
        id="infinite-grid-menu-canvas"
        ref={canvasRef}
        className="cursor-grab w-full h-full border-2 border-yellow-300 rounded-3xl
        bg-white overflow-hidden relative outline-none active:cursor-grabbing"
      />
    </div>
  );
}
